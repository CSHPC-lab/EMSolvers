...
int main(int argc, char *argv[])
{
    ...
    if (use_ofem)
    {
        filename = "symplectic2ndofem" + std::to_string(order) + "_" + std::to_string(scale) + "_" + compress(domain_size_x) + "_" + compress(domain_size_y) + "_" + compress(domain_size_z) + "_" + compress(duration) +
    ...
    {
        filename = "symplectic2ndfem" + std::to_string(order) + "_" + std::to_string(scale) + "_" + compress(domain_size_x) + "_" + compress(domain_size_y) + "_" + compress(domain_size_z) + "_" + compress(duration) +
                   "_" + compress(source_position_x) + "_" + compress(source_position_y) + "_" + compress(source_position_z) +
                   "_" + compress(observation_position_x) + "_" + compress(observation_position_y) + "_" + compress(observation_position_z) + ".csv";
    }
    // パラメータのチェック
